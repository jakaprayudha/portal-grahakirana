   ...
   <div class="content-wrapper">
         ...
         <div class="container pt-10 pb-18 pb-md-20 pt-md-14 pb-lg-21 text-center">
            <div class="row">
               <div class="col-lg-8 mx-auto mb-11">
                  <h1 class="fs-15 text-uppercase text-primary mb-3">Alumni Collaboration </h1>
                  <h3 class="display-1">Connecting Success Through Lifelong Networks</h3>
               </div>
               <!-- /column -->
            </div>
            <!-- /.row -->
      ...
      <section class="wrapper bg-light">
         <div class="container pb-23 pb-md-25">
            ...
            <!--/.row -->
            <div class="text-center mt-10"><a href="alumni/register" class="btn btn-primary rounded-pill">Login</a></div>
         </div>
         <!-- /.container -->
      </section>
      <!-- /section -->
         ...
         <div class="container py-14 py-md-17">
            <div class="row mt-md-n25 position-relative">
               <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2 mx-auto text-center">
                  <h2 class="fs-15 text-uppercase text-primary mb-3">Happy Stakeholoder</h2>
