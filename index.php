            ...
            <div class="container">
              <div class="row gx-md-8 gx-xl-12 gy-10 align-items-center text-center text-lg-start">
                <div class="col-lg-6" data-cues="slideInDown" data-group="page-title" data-delay="900">
                  <h1 class="display-2 mb-4 me-xl-5 me-xxl-0">Sekolah Tinggi Ilmu Hukum <span class="text-gradient gradient-1">Graha Kirana</span></h1>
      ...
      <div class="container pt-14 pt-md-17 pb-14 pb-md-18">
        <div class="row text-center">
          <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
            <h2 class="fs-16 text-uppercase text-gradient gradient-1 mb-3">Fasilitas</h2>
            <h3 class="display-4 mb-9 px-xl-11">Fasilitas terbaik untuk meningkatkan kegiatan akademik lebih efektif</h3>
          </div>
          <!-- /column -->
        </div>
        <!-- /.row -->
        ...
        <div class="row gx-3 gy-10 mb-15 mb-md-18 align-items-center">
          ...
          <!--/column -->
          <div class="col-lg-5 offset-lg-1">
            <h2 class="fs-16 text-uppercase text-gradient gradient-1 mb-3">Sambutan Ketua Sekolah Tinggi</h2>
            <h3 class="display-4 mb-4">M.Y.F. Hafidz Nasution S.H. LL.M.</h3>
            <p class="mb-6">
              Selamat datang di situs resmi Sekolah Tinggi Ilmu Hukum Graha Kirana (STIH Graha Kirana).
              Situs resmi ini merupakan sumber informasi kepada seluruh sivitas akademika STIH Graha Kirana yang berkaitan dengan kegiatan akademik, fasilitas kampus, inovasi dan pengembangan, dan kegiatan kampus.
            </p>
            <div class="row gy-3">
              <div class="col-xl-6">
