         ...
         <div class="container py-15 py-md-17">
            <div class="row text-center">
               <div class="col-md-10 col-lg-9 col-xxl-8 mx-auto">
                  <h2 class="fs-15 text-uppercase text-muted mb-3">Program Studi</h2>
                  <h3 class="display-3 ls-sm mb-9 px-xl-11">Universitas Graha Kirana</h3>
               </div>
               <!-- /column -->
            </div>
            <!-- /.row -->
            <div class="row gx-lg-8 gx-xl-12 gy-8">
               <div class="col-md-6 col-lg-4">
                  <div class="d-flex flex-row">
                     ...
                     <div>
                        <h4 class="fs-20 ls-sm">Program Studi Akuntansi</h4>
                        <p class="mb-0"> Menyediakan pendidikan berkualitas untuk mengelola dan menganalisis keuangan.</p>
                     </div>
                  </div>
               </div>
               <!--/column -->
               <div class="col-md-6 col-lg-4">
                  <div class="d-flex flex-row">
                     ...
                     <div>
                        <h4 class="fs-20 ls-sm">Program Studi Manajemen</h4>
                        <p class="mb-0">Mengembangkan Pemimpin dengan Keahlian Strategis dan Inovatif untuk Bisnis yang Sukses.</p>
                     </div>
                  </div>
               </div>
               <!--/column -->
               <div class="col-md-6 col-lg-4">
                  <div class="d-flex flex-row">
                     ...
                     <div>
                        <h4 class="fs-20 ls-sm">Program Studi Ilmu Hukum</h4>
                        <p class="mb-0">Mempersiapkan Ahli Hukum Berkualitas dengan Pemahaman Mendalam tentang Regulasi dan Keadilan.</p>
                     </div>
                  </div>
               </div>
               <!--/column -->
               <div class="col-md-6 col-lg-4">
                  <div class="d-flex flex-row">
                     ...
                     <div>
                        <h4 class="fs-20 ls-sm">Program Studi Ilmu Komputer</h4>
                        <p class="mb-0">Membangun Solusi Teknologi Inovatif untuk Mengatasi Tantangan Dunia Digital Modern.</p>
                     </div>
                  </div>
               </div>
               <!--/column -->
               <div class="col-md-6 col-lg-4">
                  <div class="d-flex flex-row">
                     ...
                     <div>
                        <h4 class="fs-20 ls-sm">Program Studi Sistem Informasi</h4>
                        <p class="mb-0">Mengintegrasikan Teknologi dan Manajemen untuk Solusi Bisnis yang Efektif dan Efisien.</p>
                     </div>
                  </div>
               </div>
               <!--/column -->
               <div class="col-md-6 col-lg-4">
                  <div class="d-flex flex-row">
                     ...
                     <div>
                        <h4 class="fs-20 ls-sm">Program Studi Bisnis Digital</h4>
                        <p class="mb-0">Mempersiapkan Pemimpin Masa Depan dalam Dunia Digital yang Terus Berkembang Pesat.</p>
                     </div>
                  </div>
               </div>
               <!--/column -->
            ...
            <div class="row gx-0">
               <div class="col-lg-6 ms-auto">
                  <div class="pt-13 pb-15 pb-md-17 py-lg-16 ps-lg-15 pe-xxl-16">
                     <h2 class="fs-15 text-uppercase text-muted mb-3">Apakah kamu sedang mengalami ini dalam mencari kampus ?</h2>
                     <h3 class="display-3 ls-sm mb-7">Yang harus kamu tahu tentang Graha Kirana .</h3>
                     <div class="d-flex flex-row mb-5">
                        <div>
                           <img src="./assets/img/icons/lineal/light-bulb.svg" class="svg-inject icon-svg icon-svg-md text-blue me-5 mt-1" alt="" />
                        </div>
                        <div>
                           <h4 class="fs-20 ls-sm">Kurikulum Up to Date</h4>
                     ...
                     <div class="d-flex flex-row mb-5">
                        ...
                        <div>
                           <h4 class="fs-20 ls-sm">Akreditasi "Baik Sekali"</h4>
                     ...
                     <div class="d-flex flex-row mb-5">
                        ...
                        <div>
                           <h4 class="fs-20 ls-sm">Administrasi One Stop Services</h4>
                           <p class="mb-0">Cras mattis consectetur purus sit amet. Aenean lacinia bibendum nulla sed.</p>
                        </div>
                     </div>
                     <div class="d-flex flex-row mb-5">
                        <div>
                           <img src="./assets/img/icons/lineal/check-list.svg" class="svg-inject icon-svg icon-svg-md text-info me-5 mt-1" alt="" />
                        </div>
                        <div>
                           <h4 class="fs-20 ls-sm">Ekstrakuliler Gratis dan Lengkap</h4>
                           <p class="mb-0">Cras mattis consectetur purus sit amet. Aenean lacinia bibendum nulla sed.</p>
                        </div>
                     </div>
                     <div class="d-flex flex-row mb-5">
                        <div>
                           <img src="./assets/img/icons/lineal/workflow.svg" class="svg-inject icon-svg icon-svg-md text-red me-5 mt-1" alt="" />
                        </div>
                        <div>
                           <h4 class="fs-20 ls-sm">Biaya All In One</h4>
                           <p class="mb-0">Cras mattis consectetur purus sit amet. Aenean lacinia bibendum nulla sed.</p>
                        </div>
                     </div>
                     <div class="d-flex flex-row mb-5">
                        <div>
                           <img src="./assets/img/icons/lineal/user.svg" class="svg-inject icon-svg icon-svg-md text-green me-5 mt-1" alt="" />
                        </div>
                        <div>
                           <h4 class="fs-20 ls-sm">Mendukung MBKM</h4>
                           <p class="mb-0">Cras mattis consectetur purus sit amet. Aenean lacinia bibendum nulla sed.</p>
                        </div>
                     </div>
         ...
         <div class="container py-15 py-md-17">
            <div class="row text-center">
               <div class="col-lg-10 col-xl-7 col-xxl-6 mx-auto">
                  <h2 class="fs-15 text-uppercase text-muted mb-3">Fakultas</h2>
                  <h3 class="display-3 ls-sm mb-10">Fakultas Universitas Graha Kirana</h3>
               </div>
               <!-- /column -->
            </div>
            <!-- /.row -->
                  ...
                  <div class="swiper-wrapper">
                     <div class="swiper-slide">
                        <article>
                           ...
                           <div class="post-header">
                              <h2 class="post-title h3 ls-sm mb-3"><a class="link-dark" href="./blog-post.html">Fakultas Ekonomi & Bisnis</a></h2>
                           </div>
                           <!-- /.post-header -->
                           <div class="post-footer">
                              <ul class="post-meta">
                                 <li class="post-date"><i class="uil uil-calendar-alt"></i><span>14 Apr 2022</span></li>
                                 <li class="post-comments"><a href="#"><i class="uil uil-file-alt fs-15"></i>STIE</a></li>
                              </ul>
                              <!-- /.post-meta -->
                           </div>
                           <!-- /.post-footer -->
                     ...
                     <div class="swiper-slide">
                        <article>
                           ...
                           <div class="post-header">
                              <h2 class="post-title h3 ls-sm mb-3"><a class="link-dark" href="./blog-post.html">Fakultas Hukum</a></h2>
                           </div>
                           <!-- /.post-header -->
                           <div class="post-footer">
                              <ul class="post-meta">
                                 <li class="post-date"><i class="uil uil-calendar-alt"></i><span>29 Mar 2022</span></li>
                                 <li class="post-comments"><a href="#"><i class="uil uil-file-alt fs-15"></i>STIH</a></li>
                              </ul>
                              <!-- /.post-meta -->
                           </div>
                           <!-- /.post-footer -->
                     ...
                     <div class="swiper-slide">
                        <article>
                           ...
                           <div class="post-header">
                              <h2 class="post-title h3 ls-sm mb-3"><a class="link-dark" href="./blog-post.html">Fakutlasi Teknologi Informasi</a></h2>
                           </div>
                           <!-- /.post-header -->
                           <div class="post-footer">
                              <ul class="post-meta">
                                 <li class="post-date"><i class="uil uil-calendar-alt"></i><span>26 Feb 2022</span></li>
                                 <li class="post-comments"><a href="#"><i class="uil uil-file-alt fs-15"></i>STMIK</a></li>
                              </ul>
                              <!-- /.post-meta -->
                           </div>
                           <!-- /.post-footer -->
            ...
            <div class="row gx-0">
               <div class="col-lg-6">
                  <div class="pt-13 pb-15 pb-md-17 py-lg-16 pe-lg-15">
                     <h2 class="fs-16 text-uppercase text-muted mb-3">Bergabung Bersama Kami</h2>
                     <h3 class="display-3 ls-sm mb-5">Alumni Graha Kirana</h3>
                     <p class="mb-6">Jaringan profesional terkemuka yang menghubungkan lulusan untuk kolaborasi, peluang karier, dan pengembangan berkelanjutan. Bersama, kita membangun masa depan yang lebih cerah dan sukses.</p>
                     <div class="row align-items-center counter-wrapper gy-6">
                        <div class="col-md-6">
                           <h3 class="counter counter-lg mb-1">7.930</h3>
                           <h6 class="fs-17 ls-sm mb-1">Alumni</h6>
                           <span class="ratings five"></span>
                        </div>
                        <!--/column -->
                        <div class="col-md-6">
                           <h3 class="counter counter-lg mb-1">185</h3>
                           <h6 class="fs-17 ls-sm mb-1">Stakeholoder</h6>
                           <span class="ratings five"></span>
                        </div>
                        <!--/column -->
                     </div>
      ...
      <section class="wrapper bg-white">
         <div class="container py-15 py-md-17">
            <div class="row gy-10 gy-sm-13 gx-md-8 gx-xl-12 align-items-center mb-10 mb-md-12">
               ...
               <!--/column -->
               <div class="col-lg-6">
                  <h2 class="fs-15 text-uppercase text-muted mb-3">Universitas Graha Kirana</h2>
                  <h3 class="display-3 ls-sm mb-5">Tumbuh Bersama, Berprestasi, Berintegritas : Inspirasi di Kampus Graha Kirana.</h3>
                  <p class="mb-6">ni adalah semangat yang membimbing setiap langkah di Kampus Graha Kirana, menawarkan inspirasi melalui pendidikan yang berfokus pada kolaborasi, prestasi akademis, dan integritas dalam semua aspek kehidupan kampus</p>
            ...
            <div class="row text-center">
               <div class="col-md-10 col-lg-8 col-xl-9 col-xxl-8 mx-auto">
                  ...
                  <h3 class="display-3 ls-sm mb-10 px-xl-15">We offer great prices and quality service for your business.</h3>
               </div>
               <!-- /column -->
            </div>
            <!-- /.row -->
                     ...
                     <div class="pricing card shadow-none">
                        <div class="card-body">
                           ...
                           <div class="prices text-dark">
                              <div class="price justify-content-start"><span class="price-currency">$</span><span class="price-value">9</span> <span class="price-duration">mo</span></div>
                           </div>
                           <!--/.prices -->
                           <ul class="icon-list bullet-green mt-7 mb-8">
                              ...
                              <li><i class="uil uil-times text-red"></i><span> Weekly <strong>Reports</strong> </span></li>
                              <li><i class="uil uil-times text-red"></i><span> 7/24 <strong>Support</strong></span></li>
                           </ul>
                  ...
                  <div class="col-md-6 col-lg-3">
                     <div class="pricing card shadow-none">
                        <div class="card-body">
                           ...
                           <div class="prices text-dark">
                              <div class="price justify-content-start"><span class="price-currency">$</span><span class="price-value">19</span> <span class="price-duration">mo</span></div>
                           </div>
                           <!--/.prices -->
                           <ul class="icon-list bullet-green mt-7 mb-8">
                  ...
                  <div class="col-md-6 col-lg-3">
                     <div class="pricing card bg-gray">
                        <div class="card-body">
                           ...
                           <div class="prices text-dark">
                              <div class="price justify-content-start"><span class="price-currency">$</span><span class="price-value">29</span> <span class="price-duration">mo</span></div>
                           </div>
                           <!--/.prices -->
                           <ul class="icon-list bullet-green mt-7 mb-8">
                  ...
                  <div class="col-md-6 col-lg-3">
                     <div class="pricing card shadow-none">
                        <div class="card-body">
                           ...
                           <div class="prices text-dark">
                              <div class="price justify-content-start"><span class="price-currency">$</span><span class="price-value">49</span> <span class="price-duration">mo</span></div>
                           </div>
                           <!--/.prices -->
                           <ul class="icon-list bullet-green mt-7 mb-8">
               ...
               <div class="col-xl-11 mx-auto">
                  <div class="row gx-md-8 gx-xl-12 gy-10 px-lg-5">
                     <div class="col-lg-6">
                        <div class="d-flex flex-row">
                           <div>
                              <img src="./assets/img/icons/lineal/check-list.svg" class="svg-inject icon-svg icon-svg-sm text-blue me-5 mt-1" alt="" />
                           </div>
                           <div>
                              <h4 class="fs-20 ls-sm">Can I cancel my subscription?</h4>
                              <p class="mb-0">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod.</p>
                           </div>
                        </div>
                     </div>
                     <!-- /column -->
                     <div class="col-lg-6">
                        <div class="d-flex flex-row">
                           <div>
                              <img src="./assets/img/icons/lineal/wallet.svg" class="svg-inject icon-svg icon-svg-sm text-yellow me-5 mt-1" alt="" />
                           </div>
                           <div>
                     ...
                     <div class="col-lg-6">
                        <div class="d-flex flex-row">
                           <div>
                              <img src="./assets/img/icons/lineal/insurance.svg" class="svg-inject icon-svg icon-svg-sm text-pink me-5 mt-1" alt="" />
                           </div>
                           <div>
                     ...
                     <div class="col-lg-6">
                        <div class="d-flex flex-row">
                           <div>
                              <img src="./assets/img/icons/lineal/padlock.svg" class="svg-inject icon-svg icon-svg-sm text-green me-5 mt-1" alt="" />
                           </div>
                           <div>
